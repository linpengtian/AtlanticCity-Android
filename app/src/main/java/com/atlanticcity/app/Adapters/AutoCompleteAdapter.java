...
import com.atlanticcity.app.Models.PlaceAutoComplete;
...
public class AutoCompleteAdapter extends ArrayAdapter<PlaceAutoComplete> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
     ...
     //   holder.name.setText(st.nextToken());
        holder.name.setText(holder.Place.getPlaceDesc());
        holder.imgRecent.setImageResource(R.drawable.ic_location_on_black_24dp);
        String desc_detail="";
        ...
        holder.location.setText(holder.Place.getPlaceDesc());
        return rowView;
    }
